module MadLibs
  PARTS_OF_SPEECH = {
    nouns:        %w(competitive\ advantage learning\ organization container\ platform public\ cloud\ migration Genesis Titanium GCP DCX control\ lifecycle\ management foundational\ platform
                   big\ data growth value digital\ business payments\ platform geo\ strategy Venmo Xoom\ and\ Hyperwallet\ Operations MTTR
                   platform revolution culture ecosystem monitoring\ platform blameless\ postmortems error\ budget
                   insight\ from\ data machine\ learning artificial\ intelligence design\ thinking digital\ transformation),
    plural_nouns: %w(social\ media SRE\ leaders talented\ eSRE\ developers Command\Center ),
